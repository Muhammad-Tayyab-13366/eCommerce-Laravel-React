    ...
    <>
        <footer className='py-5 text-white'>
            ...
            <div className="row ">
                ...
                <div className='pt-3'>
                    <p className='pe-3'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
                </div>
                <div className="col-md-3 pb-5">
                ...
                <ul>
                    <li><a href="">+92-320-xxxxxxx</a></li>
                    <li><a href="">info@pureware.com</a></li>
                </ul>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col-md-12 text-center text-white pt-5">
