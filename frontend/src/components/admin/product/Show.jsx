                                    ...
                                    products && products.map(product => {
                                        return (
                                            <tr key={product.id}>
                                                <td>{product.id}</td>
                                                <td>
                                                    { (product.image_url != '') ? <img src={product.image_url} width={50}/> : <img src="https://archive.org/download/placeholder-image/placeholder-image.jpg" width={50}/> }
                                                </td>
                                                <td>{product.title}</td>
                                                <td>${product.price}</td>
                                                <td>{product.qty}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <Link onClick={() => deleteProduct(product.id)} to=""  className='text-danger ms-2'>
