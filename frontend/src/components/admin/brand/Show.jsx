    ...
    const deleteBrand = (id) => {
        ...
        if(confirm('Are you sure you want to delete brand?')){
            ...
            .then( result => {
                ...
                const newBrandData = brands.filter(brand => brand.id != id)
            ...
            <div className="col-md-9">
              <div className="card shadow">
                <div className="card-body">
                    ...
                    {
                        brands && brands.length == 0 && <Nostate text="Brands not found"/>
                    }

                    {
                        brands && brands.length > 0 && loader == false
                        && 
                                    ...
                                    brands && brands.map(brand => {
                                        return (
                                            <tr key={brand.id}>
                                                ...
                                                <td>
                                                    <Link to={`/admin/brand/${brand.id}`} className='text-primary'>
                                                    ...
                                                    <Link to="" onClick={() => deleteBrand(brand.id) } className='text-danger ms-2'>
